      ...
      style="background-color: rgba(0,0,0,0.4);">
        ...
        <div 
          class="bg-white w-36 h-36 flex flex-col justify-center items-center rounded-md shadow-md">
            ...
            <!-- loading svg -->
            <svg v-if="!showsuccessicon" class="w-12" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin: auto; background: rgba(0, 0, 0, 0) none repeat scroll 0% 0%; display: block; shape-rendering: auto;" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
            ...
            <small
              v-if="msg" 
              v-html="msg"
              class="text-tgadgety tracking-wide transform -translate-y-5"
