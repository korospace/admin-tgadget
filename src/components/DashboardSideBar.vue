    ...
    <div
      ...
      class="bg-tgadgety absolute sm:relative bottom-0 z-20 w-full sm:w-36 lg-930:w-52 h-auto sm:h-full sm:flex flex-col rounded-t-md sm:rounded-r-md overflow-hidden" style="box-shadow: 0.5px 0px 8px 0px rgba(0,0,0,0.3);">
        ...
        <div class="href-wraper w-full flex-1 flex flex-row sm:flex-col overflow-auto">
            ...
            <small class="w-full flex-1 pt-4 pb-4 hidden sm:flex flex-col justify-center items-center text-white opacity-80 text-center">
                build with &hearts; by 
                <a :href="mygithub" target="_blank" class="font-extrabold underline">korospace</a>
            </small>
        </div>
    </div>
</template>
